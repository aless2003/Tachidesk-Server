...
//    }
    ...
    override fun fetchSearchAnime(
        ...
        client
            .newCall(searchAnimeRequest(page, query, filters))
            .asObservableSuccess()
            .map { response ->
    ...
    fun fetchVideo(video: Video): Observable<Response> =
        client
            // Since callWithProgress is not accessible, replaced with just newCall
            .newCall(videoRequest(video))
            .asObservableSuccess()
     ...
     */
    protected open fun videoRequest(video: Video): Request = GET(video.videoUrl!!, headers)
