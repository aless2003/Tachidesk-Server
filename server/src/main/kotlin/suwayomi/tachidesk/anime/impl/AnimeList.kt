...
object AnimeList {
    fun proxyThumbnailUrl(animeId: Int): String = "/api/v1/anime/anime/$animeId/thumbnail"
        ...
        val animeList =
            transaction {
                return@transaction animesPage.animes.map { anime ->
                    val animeEntry = AnimeTable.selectAll().where { AnimeTable.url eq anime.url }.firstOrNull()
                        ...
                        val animeId =
                            AnimeTable
                                .insertAndGetId {
                                    ...
                                    it[thumbnail_url] = anime.thumbnailUrl
