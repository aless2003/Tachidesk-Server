...
object Source {
                ...
                AnimeSourceDataClass(
                    ...
                    getExtensionIconUrl(
                        AnimeExtensionTable
                            .selectAll()
                            .where {
                                AnimeExtensionTable.id eq it[AnimeSourceTable.extension]
                            }.first()[AnimeExtensionTable.apkName],
                    ),
    ...
    fun getAnimeSource(sourceId: Long): AnimeSourceDataClass =
        transaction {
            val source = AnimeSourceTable.selectAll().where { AnimeSourceTable.id eq sourceId }.firstOrNull()
            ...
            AnimeSourceDataClass(
                ...
                source?.let {
                    AnimeExtensionTable
                        .selectAll()
                        .where {
                            AnimeExtensionTable.id eq source[AnimeSourceTable.extension]
                        }.first()[AnimeExtensionTable.iconUrl]
                },
